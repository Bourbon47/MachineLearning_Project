...
df_15 = pd.read_csv("C:/Users/wontae/Desktop/Study_/School_class/4-1/머신러닝pbl/DATA/pl_15-16.csv", encoding='cp949')
df_16 = pd.read_csv("C:/Users/wontae/Desktop/Study_/School_class/4-1/머신러닝pbl/DATA/pl_15-16.csv", encoding='cp949')
df_17 = pd.read_csv("C:/Users/wontae/Desktop/Study_/School_class/4-1/머신러닝pbl/DATA/pl_15-16.csv", encoding='cp949')
df_18 = pd.read_csv("C:/Users/wontae/Desktop/Study_/School_class/4-1/머신러닝pbl/DATA/pl_15-16.csv", encoding='cp949')
df_19 = pd.read_csv("C:/Users/wontae/Desktop/Study_/School_class/4-1/머신러닝pbl/DATA/pl_15-16.csv", encoding='cp949')
df_20 = pd.read_csv("C:/Users/wontae/Desktop/Study_/School_class/4-1/머신러닝pbl/DATA/pl_15-16.csv", encoding='cp949')
...
X = df_GK.iloc[:,1:(len(df_GK.columns)-1)]
y= df_GK.iloc[:,(len(df_GK.columns)-1)]
...
print("accuracy_score", accuracy_score(y_train, xgb_wrapper.predict(X_train)))
print("precision_score", precision_score(y_train, xgb_wrapper.predict(X_train)))
print("recall_score", recall_score(y_train, xgb_wrapper.predict(X_train)))
print("f1_score", f1_score(y_train, xgb_wrapper.predict(X_train)))
print("roc_auc_score", roc_auc_score(y_train, xgb_wrapper.predict(X_train)))

print('\n')

print("accuracy_score", accuracy_score(y_test, xgb_wrapper.predict(X_test)))
print("precision_score", precision_score(y_test, xgb_wrapper.predict(X_test)))
print("recall_score", recall_score(y_test, xgb_wrapper.predict(X_test)))
print("f1_score", f1_score(y_test, xgb_wrapper.predict(X_test)))
print("roc_auc_score", roc_auc_score(y_test, xgb_wrapper.predict(X_test)))
